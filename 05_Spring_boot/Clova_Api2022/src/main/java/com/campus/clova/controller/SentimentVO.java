...
public class SentimentVO {
    ...
    public String toString() {
        return "SentimentVO [content=" + content + ", highLength=" + highLength + ", highOffset=" + highOffset
                + ", length=" + length + ", negative=" + negative + ", neutral=" + neutral + ", offset=" + offset
                + ", positive=" + positive + ", sentiment=" + sentiment + "]";
    }
